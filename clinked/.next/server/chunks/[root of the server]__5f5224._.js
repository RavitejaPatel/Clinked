...
"[project]/src/app/api/client/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    try {
        while(true){
            const response = await fetch(`${BASE_URL}?page=${currentPage}&size=${pageSize}`, {
                method: 'GET',
                headers: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(allItems, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5f5224._.js.map